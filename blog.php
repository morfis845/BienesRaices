    ...
    <article class="entrada-blog">
        ...
        <div class="texto-entrada">
            <a href="entrada.php">
                ...
                <p>Escrito el: <span>03/05/2022</span>por: <span>Admin</span></p>
                <p>
    ...
    <article class="entrada-blog">
        <div class="imagen">
            <picture>
                ...
                <img src="public/build/img/blog3.jpg" alt="Texto entrada blog">
            </picture>
        </div>
        <div class="texto-entrada">
            <a href="entrada.php">
    ...
    <article class="entrada-blog">
        <div class="imagen">
            <picture>
                ...
                <img src="public/build/img/blog4.jpg" alt="Texto entrada blog">
            </picture>
        </div>
        <div class="texto-entrada">
            <a href="entrada.php">
